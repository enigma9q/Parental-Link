...
public class BlockAccessibilityService extends AccessibilityService{
    ...
    public void onServiceConnected(){super.onServiceConnected();h.post(timeoutCheck);notifySmall("Accessibility blocking active","Parental-Link can now push blocked apps away.");}
